...
function FacebookTokenStrategy(options, verify) {
  ...
  this.name = options.name || 'facebook-token';
  this._clientSecret = options.clientSecret;
  this._enableProof = options.enableProof;
  this._profileFields = options.profileFields || null;
  this._accessTokenName = options.accessTokenName || 'access_token';
  this._refreshTokenName = options.refreshTokenName || 'refresh_token';
}
...
FacebookTokenStrategy.prototype.authenticate = function(req, options) {
  ...
  if(req.body){
	  accessToken = req.body[this._accessTokenName];
	  refreshToken = req.body[this._refreshTokenName];
  }
  
  accessToken = accessToken || req.query[this._accessTokenName] || req.headers[this._accessTokenName];
  refreshToken = refreshToken || req.query[this._refreshTokenName] || req.headers[this._refreshTokenName];
